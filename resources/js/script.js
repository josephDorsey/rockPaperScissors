...
const computerChoice = function () {
  ...
  choice1El.src = `resources/img/choice-${choice}.png`;
};
...
const init = function () {
  ...
  round = 1;
  playing = true;
  roundNumberEl.src = `resources/img/round-1.png`;
...
btnRock.addEventListener("click", function () {
  if (playing) {
    ...
    choice0El.src = `resources/img/choice-1.png`;
    computerChoice();
    if (score0El.textContent !== "5" || score1El !== "5") {
      if (
        choice0El.getAttribute("src") === `resources/img/choice-1.png` &&
        choice1El.getAttribute("src") === `resources/img/choice-1.png`
      ) {
        round++;
        roundNumberEl.src = `resources/img/round-${round}.png`;
        removeText();
        ...
        choice0El.getAttribute("src") === `resources/img/choice-1.png` &&
        choice1El.getAttribute("src") === `resources/img/choice-2.png`
      ) {
        //   document.getElementById("score--0").textContent = increasePlayerPoints++;
        round++;
        roundNumberEl.src = `resources/img/round-${round}.png`;
...
btnPaper.addEventListener("click", function () {
  if (playing) {
    ...
    current0El.classList.remove("hidden");
    current1El.classList.remove("hidden");
    choice0El.src = `resources/img/choice-3.png`;
    computerChoice();
    if (score0El.textContent !== "5" || score1El !== "5") {
      if (
        choice0El.getAttribute("src") === `resources/img/choice-3.png` &&
        choice1El.getAttribute("src") === `resources/img/choice-3.png`
      ) {
        round++;
        roundNumberEl.src = `resources/img/round-${round}.png`;
        removeText();
...
btnScissors.addEventListener("click", function () {
  if (playing) {
    ...
    current0El.classList.remove("hidden");
    current1El.classList.remove("hidden");
    choice0El.src = `resources/img/choice-2.png`;
    computerChoice();
    if (score0El.textContent !== "5" || score1El !== "5") {
      if (
        choice0El.getAttribute("src") === `resources/img/choice-2.png` &&
        choice1El.getAttribute("src") === `resources/img/choice-2.png`
      ) {
        round++;
        roundNumberEl.src = `resources/img/round-${round}.png`;
